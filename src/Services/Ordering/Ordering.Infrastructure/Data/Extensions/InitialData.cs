...
internal class InitialData
{
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("usman", "iqbal", "uiqbal@yopmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
            var address2 = Address.Of("john", "doe", "john@yopmail.com", "Broadway No:1", "England", "Nottingham", "08050");

            var payment1 = Payment.Of("usman", "5555555555554444", "12/28", "355", 1);
